...
See [Rotating a Group of Sprites](HowToRotateSpriteGroup.md) for an example of matrix rotation and [Scaling Sprites Based On Screen Size](HowToScaleSpritesMatrix.md) for an example of matrix scaling.
